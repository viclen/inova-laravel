        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tabela-acoes :mostrarid="false" :dados="{{ json_encode($items) }}" :colunas="''"
                    :controller="'{{ $titulo }}'" :colunasvalor="['fipe', 'valor']" :podecriar="false" :podevoltar="false"
                    :podepesquisar="false" :colunascheck="['financiado']"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="{{ $nome . "_" }}" class="form-control" value="{{ $item }}" readonly />
                        </div>
                    </div>
                    @endif
                    @endforeach
