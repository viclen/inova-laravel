<template>
  <div @keyup="checkEnter">
    <b-tabs pills card v-model="tabIndex">
      ...
      <b-tab
        title="Interesses"
        :disabled="resultados !== null || passo != 0"
        active
      >
        <b-card
        ...
        >
          ...
          <template v-slot:header>
            ...
            >
              ...
              <fa-icon
                :icon="interesse.mostrar ? 'chevron-up' : 'chevron-down'"
              />
            </div>
          </template>

          <div class="text-danger mb-2" v-if="interesse.erro == true">
            Selecione um carro ou pelo menos uma caracteristica para continuar.
          </div>
          ...
          <div v-if="interesse.mostrar">
            ...
            <div v-if="interesse.caracteristicasSelecionadas.length == 0">
        ...
        <b-button
          v-if="
            interesses[interesses.length - 1].carro != null ||
            interesses[interesses.length - 1].caracteristicasSelecionadas
              .length > 0
          "
          variant="success"
          class="w-100"
      ...
      <b-tab title="Cliente" :disabled="resultados !== null || passo != 1">
        ...
        <b-form-group>
          ...
          <v-select
            ...
            v-model="cliente"
            :disabled="
              cliente == null && (dadosCliente.nome || dadosCliente.telefone)
                ? true
                : false
            "
          >
        ...
        <div v-if="erroCliente">
          <b-alert show variant="danger"
            >Por favor, selecione o cliente ou complete os dados para
            continuar.</b-alert
          >
        </div>
        <div>
      ...
      >
        ...
        <hr />
        <h4>Caracteristicas</h4>
        <div v-if="troca.caracteristicasSelecionadas.length == 0">
          Nenhuma característica selecionada. O carro será financiado?
          Automático? Qual o ano ou valor?
        </div>
        <div>
      ...
      <b-tab title="Resultados" v-if="resultados !== null">
        <div>
          <b-alert
            ...
            dismissible
            show
            >Encontramos os seguintes carros em estoque para os interesses
            cadastrados!</b-alert
          >
          <b-alert v-else variant="danger" class="text-center" show dismissible
        ...
        >
          <div class="row mb-1">
            ...
            <div class="col">
              ...
              <span
                class="text-danger"
                v-else-if="
                  match.prioridade > match.interesse.caracteristicas.length * 2
                "
                >Muito Alta</span
              >
          ...
          >
            ...
            <div class="col">
              <a :href="'/carros/' + match.estoque.carro.id">{{
                match.estoque.carro.nome
              }}</a>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="col">
              <a :href="'/marcas/' + match.estoque.carro.marca.id">{{
                match.estoque.carro.marca.nome
              }}</a>
            </div>
          </div>
          <div
            ...
            :class="{
              'row mb-1': true,
              'text-success': match.caracteristicas
                .replace('[', ' ')
                .replace(']', ' ')
                .replace(',', ' ')
                .includes(` ${caracteristica.caracteristica_id} `),
            }"
            :key="j"
          >
            <div class="col text-capitalize">
              {{ caracteristica.descricao.nome }}
            </div>
            <div class="col text-capitalize">
              {{
                getValorCaracteristica(
                  getCaracteristica(caracteristica.caracteristica_id),
